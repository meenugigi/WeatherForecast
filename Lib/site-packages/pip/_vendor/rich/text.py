...
class Text(JupyterMixin):
    ...
    def assemble(
        ...
        *parts: Union[str, "Text", Tuple[str, StyleType]],
        ...
        """Construct a text instance by combining a sequence of strings with optional css.
    ...
    def copy_styles(self, text: "Text") -> None:
        """Copy css from another Text instance.

        Args:
            text (Text): A Text instance to copy css from, must be the same length.
        """
    ...
    def split(
        ...
        *,
        ...
        """Split rich text in to lines, preserving css.
